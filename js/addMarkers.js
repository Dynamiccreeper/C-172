  ...
  init: async function () {
    ...
    dishes.map(dish => {
      ...
      if (!dish.unavailable_days.includes(days[todaysDay])) {
        ...
        model.setAttribute("position", dish.model_geomatry.position);
        model.setAttribute("rotation", dish.model_geomatry.rotation);
        model.setAttribute("scale", dish.model_geomatry.scale);
